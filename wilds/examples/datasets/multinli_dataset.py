...
from configs.model import model_defaults  # adapted
from torch.utils.data import Dataset, Subset
from datasets.confounder_dataset import ConfounderDataset
...
class MultiNLIDataset(ConfounderDataset):
    ...
    def __init__(
        ...
        assert model_type == "distilbert-base-uncased"  # new

        self.data_dir = os.path.join(
            self.root_dir, "multinli"
        )  # new, was self.root_dir, "data"
        # OLD: self.glue_dir = os.path.join(self.root_dir, "multinli", "glue_data")
        self.glue_dir = os.path.join(self.root_dir, "glue_data", "MNLI")  # NEW
        ...
        for feature_file in [
            ...
            print(f"Loading features from {self.glue_dir}/{feature_file}...")
