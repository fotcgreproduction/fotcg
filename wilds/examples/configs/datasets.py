# TODO: added spu_mnist key to dataset_defaults with default values from waterbirds
dataset_defaults = {
    "amazon": {
    ...
    "multinli": {
        ...
        "transform": "image_base",
        "loss_function": "cross_entropy",
        "groupby_fields": ["negation_words", "y"],
        "val_metric": "acc_wg",
        "val_metric_decreasing": False,
        "optimizer": "SGD",
        "optimizer_kwargs": {"momentum": 0.9},
    ...
    "iwildcam": {
        ...
        "lr": 3e-5,
        "weight_decay": 0.0,
        "batch_size": 4,  # NEW: changed from 8 for CGD
        "unlabeled_batch_size": 8,
        "n_epochs": 12,
        "optimizer": "Adam",
        "split_scheme": "official",
    ...
    "spu_mnist": {
        ...
        "optimizer_kwargs": {"momentum": 0.9},
        "scheduler": None,
        "batch_size": 512,  # new (changed from 1024)
        "lr": 1e-5,
        "weight_decay": 1.0,
        "n_epochs": 300,
        "process_outputs_function": "multiclass_logits_to_pred",
